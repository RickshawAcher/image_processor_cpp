...
#### Prewitt (-prewitt)
[Prewitt фильтр](https://en.wikipedia.org/wiki/Prewitt_operator)

Делает всё остро черно-белым

#### Pixellate (-pixellate)
[Pixellate фильтр](https://learn.microsoft.com/en-us/previous-versions/windows/internet-explorer/ie-developer/platform-apis/ms533016(v=vs.85))

Декомпозирует картинку в совокупность из ромбиков
